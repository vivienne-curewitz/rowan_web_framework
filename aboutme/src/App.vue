...
// No additional script logic needed for this static page
</script>
...
.capabilities-list, .achievements-list {
  list-style-type: none;
  padding: 0;
}

.capabilities-list li, .achievements-list li {
  margin-bottom: 1rem;
  padding: 1rem;
